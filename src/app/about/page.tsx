...
export const metadata = { title: "About · Par" };
  ...
  return (
    <main>
      ...
      <p>
        ...
        round-trip cost at your size with Par&apos;s fee printed, and a plain statement of what the token legally is, before you sign in your
        own wallet. Nothing here is a recommendation. Par shows facts; you decide.
      </p>

      <h2>What it is not</h2>
      <p>
        Par does not hold funds, does not execute trades, and does not give investment, legal or tax advice. Every swap is built through
        the Jupiter Swap API and signed in your wallet; Par sees the transaction, never your keys. The tokens are issued by third parties
      ...
      <h2>Money</h2>
      <p>
        Par takes a fixed fee on routed swaps, printed on every label, identical on every wrapper, and collected in USDC through the
        Jupiter build path. Par may earn a referral share from Tessera for wallets that opt in after a T-Token buy, and from Backpack for
      ...
      <p>
        Par was built during the Stocklana hackathon (Solana Foundation, September 2026). Third-party components: Jupiter Swap API, Pyth
